...
public class Locale implements AutoCloseable {
    ...
    public Locale(String name) {
        try (var arena = Arena.ofConfined()) {
            ...
            this.handle = (MemorySegment) ICU4X_LOCALE_NEW_MV1.invokeExact(nameSlice);
